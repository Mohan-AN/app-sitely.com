      ...
      <div className="relative hidden w-[45%] overflow-hidden border-r border-[#D6D9FC] bg-[#EEEFFE] lg:flex lg:flex-col">
        ...
        <div className="relative z-10 flex h-full flex-col p-12 xl:p-16">
          <div className="mb-20 flex items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded-xl border border-[#D6D9FC] bg-white text-lg font-black text-[#4F5DF5] shadow-sm">S</div>
            <span className="text-2xl font-extrabold tracking-normal text-[#11141A]">Sitely</span>
          </div>

          <div className="mb-12 max-w-[420px]">
            <h1 className="mb-4 text-[38px] font-bold leading-[1.1] tracking-normal text-[#11141A]">Manage every website with clarity</h1>
            <p className="text-[17px] font-medium leading-relaxed text-[#5C6270]">Track clients, projects, renewals, maintenance, and handovers from one calm workspace.</p>
          </div>
          ...
          <div className="absolute bottom-[-20%] left-[-10%] z-0 h-[40%] w-[60%] rounded-full bg-[#D6D9FC] opacity-60 blur-3xl" />
        </div>
      </div>
...
function AuthFeature({ icon: Icon, title, description }: { icon: LucideIcon; title: string; description: string }) {
  return (
    <div className="flex gap-5">
      <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-[#D6D9FC] bg-white text-[#4F5DF5]">
        <Icon className="size-6" />
      </div>
      <div className="flex flex-col pt-1">
        <h3 className="mb-1 text-[16px] font-bold text-[#4F5DF5]">{title}</h3>
        <p className="text-[13px] font-medium leading-relaxed text-[#5C6270]">{description}</p>
      </div>
    </div>
  )
}
