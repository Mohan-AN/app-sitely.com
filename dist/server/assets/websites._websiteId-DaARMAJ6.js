...
import { t as Route } from "./websites._websiteId-D_xTGFF8.js";
...
import { a as RecordPaymentDialog, c as useRequests, i as AddRequestDialog, l as useUpdateRequest, n as StatusPill, o as WebsiteEditDialog, r as RenewDomainDialog, s as useAttachInvoice, t as MaintenanceBadge } from "./status-badges-CofIg0vY.js";
		...
		children: [
			...
			editableRequest && (() => {
				return /* @__PURE__ */ jsx("button", {
					...
					title: "Edit request",
					className: cn("mt-[1px] flex size-[22px] shrink-0 items-center justify-center rounded-[6px] transition", ev.event_type === "bug" || ev.event_type === "feature" ? "bg-[#F0F1FF] text-[#4F5DF5] opacity-100 hover:bg-[#E3E7FF] hover:text-[#3F4DE0]" : "text-[#C4C9D4] opacity-0 group-hover:opacity-100 hover:bg-[#F0F1FF] hover:text-[#4F5DF5]"),
