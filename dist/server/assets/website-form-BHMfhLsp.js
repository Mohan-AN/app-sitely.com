...
import { n as cn, o as apiFetch, t as Button } from "./button-jrDuWETO.js";
import { t as Input } from "./input-BUXT0p6g.js";
import { i as listClientOptions } from "./clients-api-BVv7NTww.js";
...
function SectionHeader({ icon, title, description }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(SectionIcon, { children: icon }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
			className: "text-base font-extrabold leading-tight text-[#101828] dark:text-[#edf7ee]",
			children: title
		}), /* @__PURE__ */ jsx("p", {
...
function Field({ label, required, info, error, children }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("label", {
				className: "flex items-center gap-1 text-sm font-semibold text-[#101828] dark:text-[#edf7ee]",
				children: [
					label,
					...
					info ? /* @__PURE__ */ jsx("span", {
						className: "ml-0.5 flex size-4 items-center justify-center rounded-full bg-[#e5ebe2] text-[10px] font-bold text-[#64745F] dark:bg-[#203423] dark:text-[#9fb49b]",
						title: info,
						children: "ⓘ"
					}) : null
				]
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						className: cn("mt-5 grid gap-5", isEdit ? "lg:grid-cols-3" : ""),
			...
			/* @__PURE__ */ jsxs("div", {
				className: "mt-auto flex shrink-0 items-center justify-between gap-3 py-4",
...
//#endregion
export { useWebsite as a, useWebsites as c, SelectItem as d, SelectTrigger as f, useUpdateWebsite as i, Select$1 as l, useClientOptions as n, useWebsiteActivity as o, useDeleteWebsite as r, useWebsiteStats as s, WebsiteForm as t, SelectContent as u };
