import { n as cn } from "./button-jrDuWETO.js";
...
function StatusPill({ label }) {
	return /* @__PURE__ */ jsxs("span", {
		className: cn("inline-flex w-fit items-center gap-1.5 rounded-full px-2 py-0.5 text-xs font-medium whitespace-nowrap", STATUS_PILL_COLORS[label] ?? "bg-gray-100 text-gray-700"),
		children: [/* @__PURE__ */ jsx("span", { className: cn("size-1.5 rounded-full", DOT_COLORS[label] ?? "bg-gray-400") }), label]
	});
}
var MAINTENANCE_DOT = {
	"Over Due": "bg-red-500",
...
function MaintenanceBadge({ label }) {
	...
	return /* @__PURE__ */ jsxs("span", {
		className: cn("inline-flex w-fit items-center gap-1.5 rounded-md border px-2 py-0.5 text-xs font-medium whitespace-nowrap", MAINTENANCE_BADGE_COLORS[label] ?? "border-gray-300 text-gray-500"),
