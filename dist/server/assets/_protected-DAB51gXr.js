...
import { t as Route } from "./_protected-D-OIm8vq.js";
...
import { f as useWebsites, o as useRenewDomain, r as useDeleteWebsite, t as useClientOptions, u as useWebsiteStats } from "./use-websites-BnWcvb5r.js";
...
import { a as WebsiteEditDialog, i as RecordPaymentDialog, n as StatusPill, r as AddRequestDialog } from "./status-badges-BIBuRy4i.js";
import { t as useSettings } from "./use-settings-Cz9UnZFq.js";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { CheckCircle2, ChevronLeft, ChevronRight, Eye, Loader2, MoreVertical, Pencil, RefreshCw, Trash2 } from "lucide-react";
...
function RenewDomainDialog({ website, open, onOpenChange, onSuccess }) {
	...
	if (!open) return null;
	const diff = website.domain_renewal_date ? dayDiff$1(website.domain_renewal_date) : null;
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: phase === "success" ? /* @__PURE__ */ jsxs("div", {
				className: "flex flex-col items-center gap-3 p-8 text-center",
				children: [
					/* @__PURE__ */ jsx("div", {
						className: "flex size-12 items-center justify-center rounded-full bg-[#ECFDF5]",
						children: /* @__PURE__ */ jsx(CheckCircle2, { className: "size-6 text-[#059669]" })
					}),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						className: "font-semibold text-[#11141A]",
						children: "Domain Renewed"
					}), /* @__PURE__ */ jsxs("div", {
